        ...
        <div class="card-body">
          <form method="POST" action="/createuser">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" required value="{{ old('nama',@$nama) }}">
              @error('nama')
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" required value="{{ old('email',@$email) }}" {{ echo (@$ed==1)?'disabled':'' }}>
              @error('email')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control @error('role') is-invalid @enderror" id="role" name="role" required value="{{ old('role') }}">

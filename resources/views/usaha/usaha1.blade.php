...
@section('content')
            ...
            <table class="table table-hover table-striped">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td></td>
                    <td></td>                       
                    <td>Kelas belum diampu</td>
                    <td>
                      <a href="/ruang/" class="btn btn-info btn-sm"><i class="ti-eye"></i></a>
                      <a href="/ruang//edit" class="btn btn-warning btn-sm"><i class="ti-pencil-alt"></i></a>
                      <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal" onclick="handleDelete()"><i class="ti-trash"></i></button>
                    </td>
                  </tr>
  ...
  <script>
    function handleDelete(id){
      document.getElementById('formDelete').action = `/ruang/${id}`
    }
  </script>
@endsection